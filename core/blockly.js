 ...
 */
Blockly.promptH5 = function(message, defaultValue, callback,obj) {
  var html="<div style='position:absolute;z-index:10000;height:24px;font-size:11pt'><input value='"+defaultValue+"' id='promptInput' style='height:100%;width:100%;border:none;outline: none;-webkit-appearance: none;border-radius: 0;' type='"+obj.inputType+"'/></div>" ;
  $(document.body).append(html) ;
  obj.resizeEditor_($("#promptInput").parent().get(0)) ;
  //$("#promptInput").parent().css({height:"22px"}) ;
  $("#promptInput").focus().on("blur",function(){
    $(this).parent().remove() ;
    $(this).off() ;
    var a = $(this) ;
    setTimeout(function(){
