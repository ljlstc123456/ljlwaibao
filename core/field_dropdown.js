 ...
 * @constructor
 */
Blockly.FieldDropdown = function(menuGenerator,opt, opt_validator) {
...
Blockly.FieldDropdown.fromJson = function(options) {
  return new Blockly.FieldDropdown(options['options'],options);
};
 ...
 */
Blockly.FieldDropdown.MAX_MENU_HEIGHT = 100;
...
Blockly.FieldDropdown.prototype.showEditor_ = function() {
  ...
  var rem = 100;//parseFloat(getComputedStyle(document.getElementsByTagName("html")[0], undefined).fontSize);
  var y = Blockly.WidgetDiv.calculateY_(viewportBBox, anchorBBox, {height:2.06*rem,width:2.68*rem});
  var x = Blockly.WidgetDiv.calculateX_(viewportBBox, anchorBBox, {height:2*rem,width:2.68*rem});
  if(this.opt.otherOptions){
    window.Tool[this.opt.otherOptions](function(value){
      if (value !== null) {
